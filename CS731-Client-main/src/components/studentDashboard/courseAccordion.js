        ...
        <Box display="flex" flexDirection="row" textAlign="left" width="100%">
          ...
          <Box ml={3} display="flex" flexDirection="column" width="33%">
            ...
            <Typography variant="body2" color="green">
              ...
              {(course.attendance.Present || 0) === 1 ? 'lecture' : 'lectures'}
            </Typography>
            <Typography variant="body2" color="red">Absent: {course.attendance.Absent || 0}{" "}
              {(course.attendance.Absent || 0) === 1 ? 'lecture' : 'lectures'}</Typography>
            <Typography variant="body2" color="orange">Tardy: {course.attendance.Tardy || 0}{" "}
              {(course.attendance.Tardy || 0) === 1 ? 'lecture' : 'lectures'}</Typography>
            <Typography variant="body2" color="text.secondary">Noteworthy: {course.attendance.Noteworthy || 0}{" "}
              {(course.attendance.Noteworthy || 0) === 1 ? 'lecture' : 'lectures'}</Typography>
          </Box>
